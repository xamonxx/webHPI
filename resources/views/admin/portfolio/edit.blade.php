    ...
    <div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_420px] gap-6">
        ...
        <aside class="space-y-6">
            <section class="glass-card relative z-0 p-5 sm:p-6 rounded-2xl border border-white/5">
                ...
                <label id="photo-upload-zone" class="group flex min-h-[130px] cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-white/15 bg-black/20 p-5 text-center transition hover:border-primary/50 hover:bg-primary/5">
                    ...
                    <span class="text-sm font-bold text-gray-300">Tambah Foto</span>
