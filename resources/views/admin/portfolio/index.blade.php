                ...
                <tr class="group hover:bg-white/2 transition-colors">
                    ...
                    <td class="p-6">
                        <div class="text-gray-400 text-xs">
                            <p class="text-gray-300 font-medium">{{ \Carbon\Carbon::parse($item->completion_date ?? now())->translatedFormat('d M Y') }}</p>
                            <p>Selesai</p>
                        </div>
                    </td>

                    <td class="p-6 text-center">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold {{ $item->is_featured ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-gray-500/10 text-gray-400 border border-gray-500/20' }}">
                            @if($item->is_featured)
                ...
                <tr>
                    <td colspan="6" class="p-12 text-center">
                        <div class="flex flex-col items-center justify-center text-gray-500">
                            ...
                            <a href="{{ route('admin.portfolio.create') }}" class="px-5 py-2 bg-primary text-black font-bold rounded-lg hover:bg-primary-dark transition-colors">
                                + Tambah Baru
                            </a>
                        </div>
                    </td>
